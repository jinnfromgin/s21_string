...
Мною были выполнены реализация функций библиотеки string.h и реализация специальных функций обработки строк (Draharmo не принимал в этом участие).
...
Спасибо за помощи реализации printf (zombieest), scanf(Draharmo) и тестов (vadim_knows).
